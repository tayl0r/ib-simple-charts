((d3 => {
  ...
  cie.interpolateLab = (a, b) => {
    ...
    var ba = b.a - aa;
    var bb = b.b - ab;
    return t => lab_rgb(al + bl * t, aa + ba * t, ab + bb * t) + "";
  };

  cie.interpolateLch = (a, b) => {
    a = cie.lch(a);
    b = cie.lch(b);
    var al = a.l;
    var ac = a.c;
    ...
    return t => lch_lab(al + bl * t, ac + bc * t, ah + bh * t) + "";
  };
  ...
  function rgb_lab(r, g, b) {
    ...
    var y = xyz_lab((0.2126729 * r + 0.7151522 * g + 0.0721750 * b) / Y);
    var z = xyz_lab((0.0193339 * r + 0.1191920 * g + 0.9503041 * b) / Z);
  ...
  function xyz_lab(x) {
    return x > 0.008856 ? x ** (1 / 3) : 7.787037 * x + 4 / 29;
  }

  function xyz_rgb(r) {
    return Math.round(255 * (r <= 0.00304 ? 12.92 * r : 1.055 * (r ** (1 / 2.4)) - 0.055));
  }

  function rgb_xyz(r) {
    return (r /= 255) <= 0.04045 ? r / 12.92 : (r + 0.055) / 1.055 ** 2.4;
  }
}))(d3);
